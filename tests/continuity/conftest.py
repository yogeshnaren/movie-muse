"""Builders for continuity tests. Duplicated rather than imported from other packages."""
...
@pytest.fixture
def continuity_stack(tmp_path: Path) -> ContinuityStack:
    return boot_continuity_stack(tmp_path / "ws", make_two_scene_document())
