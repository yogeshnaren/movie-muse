"""Builders for Google Meet adapter tests. Duplicated rather than imported."""
...
def boot_meet_stack(root: Path) -> MeetStack:
...
@pytest.fixture
def meet_stack(tmp_path: Path) -> MeetStack:
    return boot_meet_stack(tmp_path / "ws")
