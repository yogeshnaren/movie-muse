"""Builders for ShotIR tests. Duplicated rather than imported from other packages."""
...
def boot_shot_stack(root: Path) -> ShotStack:
...
@pytest.fixture
def shot_stack(tmp_path: Path) -> ShotStack:
    return boot_shot_stack(tmp_path / "ws")
